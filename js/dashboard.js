(function($) {
  ...
  $(function() {
    if ($("#performaneLine").length) {
      ...
      var salesTopData = {
          ...
          datasets: [{
              ...
              pointBackgroundColor: ['#186A39)', '#186A39', '#186A39', '#186A39','#186A39)', '#186A39', '#186A39', '#186A39','#186A39)', '#186A39', '#186A39', '#186A39','#186A39)'],
            ...
            pointBackgroundColor: ['#f0b24f)', '#f0b24f', '#f0b24f', '#f0b24f','#f0b24f)', '#f0b24f', '#f0b24f', '#f0b24f','#f0b24f)', '#f0b24f', '#f0b24f', '#f0b24f','#f0b24f)'],
              pointBorderColor: ['#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff',],
        }]
      };
    ...
    if ($("#marketingOverview-dark").length) {
      ...
      var marketingOverview2Chart = document.getElementById("marketingOverview2").getContext('2d');
      var marketingOverview2Data = {
          labels: ["JAN","FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT", "NOV", "DEC"],
          datasets: [{
              label: 'Last week',
              data: [110, 220, 200, 190, 220, 110, 210, 110, 205, 202, 201, 150],
      ...
      var marketingOverview2 = new Chart(marketingOverview2Chart, {
          type: 'bar',
          data: marketingOverview2Data,
          options: marketingOverview2Options
      });
      document.getElementById('marketing-overview-legend2').innerHTML = marketingOverview2.generateLegend();
    }
    if ($("#marketingOverview2-dark").length) {
      var marketingOverviewChartDark = document.getElementById("marketingOverview2-dark").getContext('2d');
      var marketingOverviewDataDark = {
          labels: ["JAN","FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT", "NOV", "DEC"],
          datasets: [{
              label: 'Last week',
      ...
      var marketingOverview2OptionsDark = {
        responsive: true,
        maintainAspectRatio: false,
          scales: {
              yAxes: [{
          ...
          legendCallback: function (chart) {
            var text = [];
            text.push('<div class="chartjs-legend2"><ul>');
            for (var i = 0; i < chart.data.datasets.length; i++) {
              console.log(chart.data.datasets[i]); // see what's inside the obj.
              text.push('<li class="text-muted text-small">');
              text.push('<span style="background-color:' + chart.data.datasets[i].borderColor + '">' + '</span>');
      ...
      var marketingOverview2Dark = new Chart(marketingOverview2ChartDark, {
          type: 'bar',
          data: marketingOverview2DataDark,
          options: marketingOverview2OptionsDark
      });
      document.getElementById('marketing-overview-legend2').innerHTML = marketingOverview2Dark.generateLegend();
    }
...
document.getElementById("demo").innerHTML = day + "," + " " + d.getDate() + " " + month + ", " + d.getFullYear();

  setInterval(function(){ 
  const d = new Date().toLocaleTimeString();
  document.getElementById("demo1").innerHTML = d ;}, 1000);
